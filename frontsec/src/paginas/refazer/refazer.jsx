...
export default function Refazer({onAccept}) {
   ...
   const navigate = useNavigate();
    ...
    return(
        ...
        <h3>Como utilizamos os seus dados?</h3>
            ...
            <p>você permite?....</p>
            <input type="checkbox"></input> */}
            <p className="espassamento"> A seguir, para melhorar nossos serviços, pedimos sua permissão com os seguintes critérios opcionais:</p>
